...
class Example extends Component{
    constructor(){
        ...
        this.state = {
            ...
            showPopupWithoutCloseButton: false
        };
        this.showDefaultPopup = this.showDefaultPopup.bind(this);
        this.hidePopup = this.hidePopup.bind(this);
        this.togglePopupWithoutCloseButton = this.togglePopupWithoutCloseButton.bind(this)
    }

    render(){
        const text = <p>This is a paragraph which is a child to the popup container. You can place here a Yes/No buttons, forms, picture preview or really anything.</p>
        return <section>
            {this.state.showDefaultPopup && <Popup close={this.hidePopup}>{text}</Popup>}
            {this.state.showPopupWithoutCloseButton && <Popup withoutCloseButton close={this.hidePopup}>{text}</Popup>}
            <input type="button" value="Open popup" onClick={this.showDefaultPopup} /><br/>
            <input type="button" value="Toggle popup without close button" onClick={this.togglePopupWithoutCloseButton} />
    ...
    showDefaultPopup () {
        this.setState({ showDefaultPopup: true });
    }

    togglePopupWithoutCloseButton () {
        this.setState({ showPopupWithoutCloseButton: !this.state.showPopupWithoutCloseButton })
    }
